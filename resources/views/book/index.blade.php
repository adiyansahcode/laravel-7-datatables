...
<link rel="stylesheet" href="{{ asset('vendor/datatables-plugins/fixedheader/css/fixedHeader.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('vendor/datatables-plugins/select/css/select.bootstrap4.min.css') }}">
...
<script src="{{ asset('vendor/datatables-plugins/fixedheader/js/fixedHeader.bootstrap4.min.js') }}"></script>
<script src="{{ asset('vendor/datatables-plugins/select/js/dataTables.select.min.js') }}"></script>
<script src="{{ asset('vendor/datatables-plugins/select/js/select.bootstrap4.min.js') }}"></script>
